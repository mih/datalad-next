...
def test_split_decoding():
    ...
    r = tuple(decode_processor([b'abc' + part_1, part_2 + b'def']))
...
def test_unfixable_error_decoding():
    ...
    # check that incomplete encodings are caught
    r = tuple(decode_processor([b'abc' + part_1 + b'def' + part_1, part_2 + b'ghi']))
...
def test_performance():
    ...
    d1 = timeit.timeit(lambda: tuple(decode_processor(iterable)), number=1000000)
