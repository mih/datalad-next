...
def decode_processor(iterable: Iterable[bytes],
    ...
    """ Decode bytes yielded by ``iterable`` into strings

    Parameters
    ----------
    iterable: Iterable[bytes]
        The iterable that yields bytes that should be decoded
    encoding: str (default: ``'utf-8'``)
        The encoding that is used to decode the bytes yielded by ``iterable``
    ...
    ------
    str
        The decoded strings that are generated by decoding the data yielded by
